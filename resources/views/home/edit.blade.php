...
<div class="row">
  <div class="d-flex justify-content-center card my-4 p-3">
    <div class="form-row d-flex justify-content-between">
      <h6 class="text-black text-capitalize ps-3">Update Facilities</h6>
      <a href="{{url('/homeindex')}}" style="color:white">
      ...
      <div class="table-responsive p-0">
        <table class="table align-items-center mb-0">
          <thead>
            <tr>
              <div class="container">
                <form action="{{route('homeupdate', ['id'=> $data->id])}}" method="post">
                  @method('PUT')
                  @csrf
