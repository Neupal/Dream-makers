...
<head>
	...
	<title>Enegix - Login Business Multipurpose Bootstrap 4 Html Template</title>
		    		...
		    		<div class="login_content p-5 bg-white">
					    ...
					    <form>
							...
							<div class="form-check">
					  		...
					  		<button class="btn btn-primary btn-block mt-4" type="button">Acess Members Area</button>
						</form>
							<p class="mt-3 text-center login_content form-check-label">Don't have an account?&nbsp;<a href="registration_page.html">Sign Up</a></p>
					</div>
		    	</div>
		    </div>
	 <!-- ***** End Main Wrapper ***** -->
