...
<div class="row">
    <div class="d-flex justify-content-center card my-4 p-3">
        <div class="form-row d-flex justify-content-between">
            <h6 class="text-black text-capitalize ps-3">Update Leadership</h6>
            ...
            <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                    <thead>
                        <tr>
                            <div class="container">
                                <form action="{{route('leadershipupdate', ['id'=> $data->id])}}" method="post" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    <div class="container mt-4 card p-3 bg-white">
                                        ...
                                        <div class="form-group col-md-6 required" style="color: black">
                                            ...
                                            <input type="text" id="position" name="position" class="form-control border border-black border-2" value="{{$data->position??''}}">
                                            <span class="text-danger">
                                            </span>
                                        </div>
                                        <br>
                                        ...
                                        <div class="form-group col-md-6 required" style="color: black">
                                            ...
                                            <input type="text" id="email" name="email" class="form-control border border-black border-2" value="{{$data->email??''}}">
                                            <span class="text-danger">
                                            </span>
                                        </div>
                                        <br>
                                        ...
                                        <div class="form-group col-md-6 required" style="color: black">
                                            ...
                                            <input type="text" id="experience" name="experience" class="form-control border border-black border-2" value="{{$data->experience??''}}">
                                            <span class="text-danger">
                                            </span>
                                        </div>
                                        <br>
